...
public class CartRepository : ICart
{
    ...
    public async Task<ShopCartItem> GetShopCartItemAsync(string shopCartItemId)
    {
        return await _applicationContext.ShopCartItems.FirstOrDefaultAsync(e => e.Id.ToString() == shopCartItemId);
    }
    ...
    {
        await _applicationContext.ShopCartItems.Where(e => e.ShopCartId == ShopCartId).ExecuteDeleteAsync();
    }
}